...
export class ProfilePage {
    ...
    share_code()
    {
        ...
        this.socialSharing.share("Hey there join me (" + this.karigar_detail.full_name + "-" + this.karigar_detail.mobile_no + ") on Star Laminates , a Carpenter app. Enter my code *" + this.karigar_detail.referral_code + "* to earn points back in your wallet!", "", image, app_url)
        .then(resp=>{
