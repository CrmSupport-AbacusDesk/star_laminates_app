...
export class ConstantProvider {
  ...
  // live url
  public rootUrl: string = 'https://devcrm.abacusdesk.com/starlaminates/dd_api/';  
  public server_url: string = this.rootUrl + 'index.php/app/';
  public upload_url: string ='https://devcrm.abacusdesk.com/starlaminates/dd_api/app/uploads/';
